...
- Non-flake rebuild (matches `scripts/pull-and-rebuild.sh`): `sudo nixos-rebuild switch`
- Flake rebuild (using this repo's flake output): `sudo nixos-rebuild switch --flake .#nixos`
